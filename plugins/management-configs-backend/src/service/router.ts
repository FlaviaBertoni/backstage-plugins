...
const exampleEnv = [
  {
    key: 'contact-phone',
    updatedOn: '2023-08-17T15:58:14.000Z',
    type: 'env',
    value: '(00) 1234-1234',
  },
  {
    key: 'contact-emails',
    createdOn: '2023-08-17T15:58:14.000Z',
    updatedOn: '2023-08-17T15:58:14.000Z',
    type: 'env',
    value:
      "[{ name: 'João', email: 'joao@support.com'}, { name: 'Maria', email: 'maria@support.com'}]",
  },
];

const exampleFeatureFlag = [
  {
    key: 'ft-user-forgot-password',
    updatedOn: '2023-08-17T15:58:14.000Z',
    type: 'featureflag',
    value: true,
  },
