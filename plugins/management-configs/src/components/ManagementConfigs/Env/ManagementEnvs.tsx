...
export const ManagementEnvs = ({ configs, title }: ManagementConfigsProps) => {
  ...
  const createPermission = usePermission({ permission: manegementConfigsEnvsCreatePermission })?.allowed;
  const deletePermission = usePermission({ permission: manegementConfigsEnvsDeletePermission })?.allowed;
